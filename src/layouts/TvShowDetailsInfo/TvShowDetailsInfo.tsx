...
import { useGetTvShowTrailersQuery } from '../../API/tvShowTrailersApi/getTvShowTrailersEndpoint';
...
export const TvShowDetailsInfo: FC<TvShowDetailsInfoProps> = ({
  ...
  const { data: tvShowTrailersData } = useGetTvShowTrailersQuery(tvShowId);
  const trailers =
    tvShowTrailersData?.results.filter(
